	...
	var Button = {
		...
		props: {
			...
			size: {
				...
				default: 'large',
				validator: function validator(val) {
					return oneOf(val, _DEFAULT$1.size);
				}
			},
			shape: {
				type: String,
			...
			type: {
				...
				default: '',
				validator: function validator(val) {
					return oneOf(val, _DEFAULT$1.type);
				}
			},
			nativeType: {
				type: String,
				default: 'button',
				validator: function validator(val) {
					return oneOf(val, _DEFAULT$1.nativeType);
				}
			}
		},
		computed: {
			classes: function classes() {
				...
				list.push(''.concat(CLASS_PREFIX$2, '--').concat(type || 'defulat'));
				...
				if (disabled) {
					list.push(''.concat(CLASS_PREFIX$2, '--disabled'));
				}
