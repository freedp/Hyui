...
var HyUi = (function() {
	...
	var CLASS_PREFIX$2 = 'hy-skeleton'; // 默认配置
	...
	var Skeleton = {
		...
		methods: {
					...
					list.push(
						h(
							...
							[
								h('span', {
									class: [
										''.concat(CLASS_PREFIX$2, '-avatar'),
										''
											.concat(CLASS_PREFIX$2, '-avatar--')
											.concat(avatarProp.size),
										''
											.concat(CLASS_PREFIX$2, '-avatar--')
											.concat(avatarProp.shape)
									]
								})
							]
						)
			...
			renderTitle: function renderTitle() {
				...
				if (title) {
					list.push(
						h('h3', {
							class: ''.concat(CLASS_PREFIX$2, '-title'),
							style: {
								width: titleProp
							}
						})
		...
		render: function render(h) {
			...
			var bodyTpl = h(
				'div',
				{
					class: ''.concat(CLASS_PREFIX$2, '-content')
				},
				[
					this.renderTitle(),
					h(
						'ul',
						{
							class: ''.concat(CLASS_PREFIX$2, '-graph')
						},
						this.renderRows()
					)
				]
			...
			var defaultTpl = h(
				'div',
				{
					class: [
						...
						_defineProperty(
							_ref,
							''.concat(CLASS_PREFIX$2, '-active'),
							active
						),
						_defineProperty(
							_ref,
							''.concat(CLASS_PREFIX$2, '-has-avatar'),
							avatar
						),
						_ref)
					],
	 ...
	 * 描述：面包屑
	 */
	var CLASS_PREFIX$3 = 'hy-breadcrumb';
	var Breadcrumb = {
		name: 'Breadcrumb',
		props: {
			tag: {
	...
	var __vue_render__ = function() {
		...
		return _c(
			'span',
			{ class: [_vm.CLASS_PREFIX + '-item__panel'] },
			[
				_c(
					'router-link',
					{
						class: [
							_vm.CLASS_PREFIX + '-item__inner',
							{ 'is-link': !!this.to }
						],
				...
				_vm._v(' '),
				_c('span', { class: [_vm.CLASS_PREFIX + '-item__separator'] }, [
